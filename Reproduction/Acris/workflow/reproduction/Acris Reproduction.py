...
person must decide.  The machinery is ../../../rulebook/rulebook.py, shared with every source; this file is the
...
cross-station status - are written once in rulebook.py's docstring.
